...
use super::{ChatMessage, Ergon, Message, Sender};
...
pub fn chat_view(state: &Ergon) -> Element<Message> {
...
pub fn update_chat(state: &mut Ergon, action: Message) {
    match action {
